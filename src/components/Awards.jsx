...
function Awards() {
  return (
    <div className="awards_section" id="awards">
      <h1>Awards &amp; Honors</h1>
      <p><FaMedal className="award_icon"/><span className="highlighted">Selected </span>to participate in the prestigious Cornell, Maryland, Max Planck Pre-Doctoral Research School (CMMRS 2025) in Computer Science in Saarbrücken, Germany</p>
