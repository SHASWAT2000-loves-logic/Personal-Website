...
function Awards() {
  return (
    <div className="awards_section" id="awards">
      <h1>Awards &amp; Honors</h1>
      <p><FaMedal className="award_icon"/><span className="highlighted">Summa Cum Laude </span>(2022); graduated with the highest honors of having 3.9+ GPA upon graduation</p>
