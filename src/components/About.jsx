...
function About() {
  return (
    <div className="about_section" id="about">
      ...
      <p>I am a second-year MSCS student at Purdue with one year of full-time work experience as a software engineer. In my short professional journey, I have built a company website for a startup, maintained legacy applications for a state government, and am currently redesigning and developing the website of an edtech company. In addition to my industry experience, I have considerable research experience. As an undergraduate, I was twice a summer intern at Purdue—working on multi-robot systems during the first summer, and building a "robotic" bicycle crank with sensing and computational capabilities to accurately measure cyclist performance during the second. I also interned at Stanford University as part of the NASA ULI program, where I developed an algorithm for autonomous robot navigation through a driving course consisting of static obstacles.</p>
      <br />
