    ...
    {/* First experience */}
      ...
      <div className="card">
        ...
        <ul className="position_description">
          ...
          <li><span className="bold">Tested</span> the CNN model to an <span className="bold">accuracy</span> of <span className="bold">80%</span> after using it on validation data</li>
      ...
      <div className="card">
        ...
        <ul className="position_description">
          ...
          <li>Created CAD model of an <span className="bold">IoT based</span>, "<span className="bold">smart</span>" bicycle crank using <span className="bold">Autodesk Fusion 360</span></li>
      ...
      <div className="card">
        ...
        <ul className="position_description">
          ...
          <li><span className="bold">Created</span> and <span className="bold">deployed</span> a Python simulation to analyze and plot the time taken by the robots to agree on tasks using consensus algorithms in a discrete time model</li>
         </ul>
      </div>
